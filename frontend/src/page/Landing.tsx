          ...
          >
            <CarouselContent>
              ...
              <CarouselItem className="md:basis-1/2 lg:basis-1/3">
                <Card className="p-6 backdrop-blur-sm bg-card/50 border-border h-full">
                  <div className="text-muted-foreground mb-6">
                    "As a student, this tool is invaluable. I can watch lectures
                    and get clarifications on complex topics without rewinding
                    constantly."
                  </div>
                  <div className="flex justify-between  items-center gap-3">
                    <div className="flex gap-4">
              ...
              <CarouselItem className="md:basis-1/2 lg:basis-1/3">
                <Card className="p-6 backdrop-blur-sm bg-card/50 border-border h-full">
                  <div className="text-muted-foreground mb-6">
                    ...
                    personal tutor available 24/7. Absolutely game-changing Application"
                  </div>
                  <div className="flex justify-between  items-center gap-3">
                    <div className="flex gap-4">
                      <Avatar>
      ...
      <div className="container mx-auto px-4 md:py-24">
        <Card className="p-12 backdrop-blur-sm bg-gradient-to-br from-primary/10 to-accent/10 border-primary/20 text-center">
          ...
          <p className="text-xl text-muted-foreground mb-8 max-w-4xl mx-auto">
            Join thousands of learners who are saving hours every week with AI-powered video Q&A
          </p>
          <Button
            size="lg"
            variant="hero"
